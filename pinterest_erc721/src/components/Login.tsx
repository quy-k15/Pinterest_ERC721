...
const Login: React.FC<LoginProps> = ({ open, handleOpen }) => {
    ...
    const connect = async (e: FormEvent<HTMLButtonElement>) => {
        ...
        if (window.ethereum) {
            ...
            } catch (error: any) {  // Type error as any to handle unknown properties
    ...
    const getContract = async (address: string, abi: any[], provider: Web3Provider) => {
    ...
    const readContract = async (contract: ethers.Contract) => {
        try {
            ...
            console.log(`address: ${address}Token Name: ${tokenName}, Symbol: ${tokenSymbol}`);
        } catch (error: any) {
            console.error("Failed to execute contract call:", error);
            if (error.reason) {
                console.error("Reversion reason:", error.reason);
            }
        }
    ...
    // const open = useSelector((state: RootState) => state.login.isOpen);
    // const dispatch = useDispatch();

    // const handleOpen = () => dispatch(toggleLogin());
                ...
                <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex justify-center items-center z-50">
                    <div className="bg-white p-5 rounded-lg max-w-md w-full">
                        ...
                        <div style={{ textAlign: 'center' }}>
                            <img className="w-10 mx-auto mb-2" src={img_Logo} alt='img_logo'></img>
                        ...
                        <div className="mt-4">
                            ...
                            <div className="mt-3 space-y-2 ">
                                <button onClick={connect} className="flex items-center justify-center p-4 shadow-md hover:bg-gray-200 rounded-xl mx-auto px-16 my-5">
                                    <img
                        ...
                        <div className="mt-4">
                            ...
                            <div className="relative w-full flex items-center rounded-xl mx-auto my-5 shadow-md hover:bg-gray-200">
                                <input className="pl-10 pr-16 py-4 w-full rounded-xl focus:outline-none" placeholder="Tiếp tục với Email" />
